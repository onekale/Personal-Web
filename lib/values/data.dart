...
class Data {
  ...
  static List<CertificationData> certificationData = [
    CertificationData(
      ...
      url: StringConst.ESHE_1_URL,
      image: ImagePath.ESHE_1,
      imageSize: 0.325,
      awardedBy: StringConst.ESHE,
    ),
    CertificationData(
      title: StringConst.ESHE_4_TITLE,
      url: StringConst.ESHE_4_URL,
      image: ImagePath.ESHE_4,
      imageSize: 0.325,
      awardedBy: StringConst.GOOGLE,
    ),
    CertificationData(
      title: StringConst.ESHE_2_TITLE,
      url: StringConst.ESHE_2_URL,
      image: ImagePath.ESHE_2,
      imageSize: 0.325,
      awardedBy: StringConst.ESHE,
    ),
    CertificationData(
      title: StringConst.DATA_SCIENCE,
      url: StringConst.ESHE_5_URL,
      image: ImagePath.ESHE_5,
      imageSize: 0.325,
      awardedBy: StringConst.ESHE,
    ),
    CertificationData(
      title: StringConst.ANDROID_BASICS,
      url: StringConst.ESHE_3_URL,
      image: ImagePath.ESHE_3,
      imageSize: 0.325,
      awardedBy: StringConst.ESHE,
    ),
  ];
